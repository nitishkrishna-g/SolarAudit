...
const widgets: Record<string, { title: string; sub: string; cta: string; link: string; emoji: string; color: string }> = {
    ...
    hardware: {
        emoji: "⚡",
        title: "Top Pick: Luminous Zelio",
        sub: "Best value hybrid inverter for 2BHK homes",
    ...
    installation: {
        emoji: "📐",
        title: "Solar Radiation Meter",
        sub: "Check your roof's solar potential before you buy",
        cta: "Buy on Amazon (₹1,500)",
    ...
    maintenance: {
        emoji: "🧹",
        title: "Solar Mop Kit",
        sub: "Telescopic pole + nylon brush. Saves ₹500/month",
        cta: "Buy on Amazon",
